...
public class TC025_UserUsernameOrEmailBlank {
    private final String testName = "US03 || TC025-User leaves username or email blank";
    private final String expectedResult = "UUser cannot sign in and show warning message";
    String actualResult = "User couldn't sign in and showed warning message";

    @Test(testName = testName, description = "<span style='color:green; font-weight:bold; font-size: 16px'>Expected Result: </span> " + expectedResult)
    public void userUsernameOrEmailBlank() {
        ...
        extentTest.pass("3) *** User leaves username or email address blank ***");
