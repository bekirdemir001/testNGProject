...
public class TC09_SuccessfulPasswordStrong {
    private final String testName = "US01 || TC08-Strong Password Message ";
    ...
    public void successfulCostumerRegistration() throws IOException {
        String testCaseNumber = "US01_TC09";
        String reportMessage = "User registered and showed 'Strong' warning message!";
        ...
        myAccountPage.passwordInputBox.sendKeys(faker.internet().password());
        extentTest.pass("*** STRONG PASSWORD IS ENTERED ***");

        ReusableMethods.waitForVisibility(myAccountPage.strongWarningMessage, 15);
        Assert.assertTrue(myAccountPage.strongWarningMessage.isDisplayed());
