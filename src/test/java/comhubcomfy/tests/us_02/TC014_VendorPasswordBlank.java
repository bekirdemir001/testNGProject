...
public class TC014_VendorPasswordBlank {
    private final String testName = "US02 || TC014-Vendor leaves password blank";
    ...
    public void vendorPasswordBlank(){
        ...
        extentTest.pass("8) *** Vendor leaves password blank ***");

        vendorRegisterPage.confirmPasswordInputBox.sendKeys(faker.internet().password());
        extentTest.pass("9) Vendor enters any password to confirm password");
