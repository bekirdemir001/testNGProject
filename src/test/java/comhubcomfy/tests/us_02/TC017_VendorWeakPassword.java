...
public class TC017_VendorWeakPassword {
    private final String testName = "US02 || TC017-Vendor enters weak password";
    ...
    public void vendorWeakPassword(){
        ...
        vendorRegisterPage.passwordInputBox.sendKeys(ConfigReader.getProperty("generatedVendorWeakPassword"));
        extentTest.pass("8) *** Vendor enters weak password ***");

        vendorRegisterPage.confirmPasswordInputBox.sendKeys(ConfigReader.getProperty("generatedVendorWeakPassword"));
