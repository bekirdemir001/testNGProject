...
public class TC006_PasswordVeryWeak_ParallelTest {
    ...
    public void passwordVeryWeak(){
        ...
        passwordInputBox.sendKeys(ConfigReader.getProperty("generatedVeryWeakPassword"));
        Extent_Reports.extentTestPass("6) *** User enters very weak password ***");
