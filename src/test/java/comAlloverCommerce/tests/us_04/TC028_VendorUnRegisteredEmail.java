...
public class TC028_VendorUnRegisteredEmail {
    private final String testName = "US03 || TC028-Vendor enters unregistered email";
    ...
    public void vendorUnRegisteredEmail(){
        ...
        extentTest.pass("3) *** Vendor enters unregistered email address ***");
