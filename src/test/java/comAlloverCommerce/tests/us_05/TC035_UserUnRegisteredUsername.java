...
public class TC035_UserUnRegisteredUsername {
    private final String testName = "US03 || TC035-User enters unregistered username";
    private final String expectedResult = "User cannot reset his/her password with unregistered username and show 'Invalid username or email.' warning message";
    ...
    public void userUnRegisteredUsername(){
        ...
        lostPassword.usernameOrEmailInputBox.sendKeys(faker.name().username());
        extentTest.pass("4) User enters unregistered username");
