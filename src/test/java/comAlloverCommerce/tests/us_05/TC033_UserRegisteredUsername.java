...
public class TC033_UserRegisteredUsername {
    ...
    private final String expectedResult = "User can reset your password and show 'Your password has been reset successfully.' warning message";
    String actualResult = "User can reset your password and show 'Your password has been reset successfully.' warning message";
