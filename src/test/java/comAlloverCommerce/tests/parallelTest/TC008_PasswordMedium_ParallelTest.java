...
public class TC008_PasswordMedium_ParallelTest {
    ...
    public void passwordMedium(){
        ...
        passwordInputBox.sendKeys(ConfigReader.getProperty("generatedMediumPassword"));
        Extent_Reports.extentTestPass("6) *** User enters medium password ***");
